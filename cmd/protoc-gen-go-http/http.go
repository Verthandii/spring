...
const (
	...
	xhttpPackage   = protogen.GoImportPath("github.com/Verthandii/spring/transport/ihttp")
)

var methodSets = make(map[string]int)

// generateFile generates a _http.pb.go file.
func generateFile(gen *protogen.Plugin, file *protogen.File, appPackage string, omitempty bool, omitemptyPrefix string) *protogen.GeneratedFile {
	...
	g.P()
	generateFileContent(gen, file, g, appPackage, omitempty, omitemptyPrefix)
	return g
}

func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, appPackage string, omitempty bool, omitemptyPrefix string) {
	if len(file.Services) == 0 {
		return
	}
	g.P("// This is a compile-time assertion to ensure that this generated file")
	g.P("// is compatible with the yostar package it is being compiled against.")
	g.P("var _ = new(", protogen.GoImportPath(appPackage).Ident("Context"), ")")
	g.P("var _ = new(", contextPackage.Ident("Context"), ")")
	g.P("var _ = new(", xhttpPackage.Ident("Context"), ")")
	g.P()
